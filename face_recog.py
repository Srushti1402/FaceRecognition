...
subjects=["Mindy Kaling","Barack Obama","Madhuri Dixit","Narendra Modi"]
...
#draw name of predicted person
    draw_text(img, str(label_text), rect[0], rect[1]-5)
    return img



#load test images
#test1-mindy,test21-shahrukh,test3-obama,test4-madhuri
...
#display both images
cv2.imshow("Mindy test", predicted_img1)
cv2.imshow("Obama test", predicted_img2)
cv2.waitKey(0)
cv2.destroyAllWindows()
cv2.waitKey(1)
cv2.destroyAllWindows()
